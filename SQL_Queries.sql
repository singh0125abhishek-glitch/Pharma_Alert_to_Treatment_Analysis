...
____________________________________________________________________________________________________________________________________________
1.-- Top 10 by Alert Volume: Which 10 doctors have the highest total number of alerts generated?

select HCP_ID, count(Lab_Result) as Total_Alert from Alerts
group by HCP_ID order by 2 desc limit 10;
____________________________________________________________________________________________________________________________________________
____________________________________________________________________________________________________________________________________________
2.-- Top 10 by Prescription Volume: Which 10 doctors from the alerts universe have written the highest prescription volume in the Sales data?
...
____________________________________________________________________________________________________________________________________________
____________________________________________________________________________________________________________________________________________
3.--Identify all doctors from the alerts universe who received positive lab test alerts, indicating that the patient likely
...
____________________________________________________________________________________________________________________________________________
____________________________________________________________________________________________________________________________________________
4. -- Create a funnel showing HCPs with at least one positive alert, multiple positive alerts, 
...
____________________________________________________________________________________________________________________________________________
____________________________________________________________________________________________________________________________________________
5. -- Use the Top 10 doctors by total alert volume from Question 1.
...
____________________________________________________________________________________________________________________________________________
____________________________________________________________________________________________________________________________________________
6. -- Identify which competitor drug accounts for the highest prescription volume and is capturing 
...
____________________________________________________________________________________________________________________________________________
____________________________________________________________________________________________________________________________________________
7. -- Using the Affiliation dataset, identify the Top 10 accounts with the highest alert volume based on 
...
____________________________________________________________________________________________________________________________________________
____________________________________________________________________________________________________________________________________________
8.-- Using the Affiliation dataset, determine the total number of doctors associated with each account. 
...
____________________________________________________________________________________________________________________________________________
____________________________________________________________________________________________________________________________________________
9. -- Basic lift: Define a 90-day before and 90-day after window around each doctor's first positive alert. 
...
_____________________________________________________________________________________________________________________________________________
10. --  Segment the lift: Split all doctors into 3 behavioral bucket as mentioned in the formula table. 
